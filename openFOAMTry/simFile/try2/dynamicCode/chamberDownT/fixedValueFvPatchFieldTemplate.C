...
// has been loaded
extern "C" void chamberDownT_20ec42ca85ea0edcbbe96f36ed516a1ad0b6ed99(bool load)
{
    if (load)
    {
...
(
    fvPatchScalarField,
    chamberDownTFixedValueFvPatchScalarField
);
    ...
    parent_bctype(p, iF)
{
    if (false)
    {
        printMessage("Construct chamberDownT : patch/DimensionedField");
    }
}
...
chamberDownTFixedValueFvPatchScalarField
(
    const chamberDownTFixedValueFvPatchScalarField& rhs,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
    ...
    parent_bctype(rhs, p, iF, mapper)
{
    if (false)
    {
        printMessage("Construct chamberDownT : patch/DimensionedField/mapper");
    }
}
    ...
    parent_bctype(p, iF, dict)
{
    if (false)
    {
        printMessage("Construct chamberDownT : patch/dictionary");
    }
}
    ...
    dictionaryContent(rhs)
{
    if (false)
    {
        printMessage("Copy construct chamberDownT");
    }
}
    ...
    parent_bctype(rhs, iF)
{
    if (false)
    {
        printMessage("Construct chamberDownT : copy/DimensionedField");
    }
}
...
~chamberDownTFixedValueFvPatchScalarField()
{
    if (false)
    {
        printMessage("Destroy chamberDownT");
    }
}
...
void
Foam::
chamberDownTFixedValueFvPatchScalarField::updateCoeffs()
{
    if (this->updated())
    {
        return;
    ...
    if (false)
    {
        printMessage("updateCoeffs chamberDownT");
    }

//{{{ begin code
    #line 92 "/home/lavender/OpenFoamUbu/CFDSpaceCombustionChamber/openFOAMTry/simFile/0/T/boundaryField/chamber_wall_down"
